...
cp monster_test_generated.rs ./rust_usage_test/src/
cp namespace_test/namespace_test1_generated.rs namespace_test/namespace_test2_generated.rs ./rust_usage_test/src/namespace_test/

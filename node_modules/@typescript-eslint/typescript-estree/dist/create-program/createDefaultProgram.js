...
function createDefaultProgram(code, extra) {
    ...
    const commandLine = typescript_1.default.getParsedCommandLineOfConfigFile(tsconfigPath, shared_1.DEFAULT_COMPILER_OPTIONS, Object.assign(Object.assign({}, typescript_1.default.sys), { onUnRecoverableConfigFileDiagnostic: () => { } }));
    if (!commandLine) {
        return undefined;
    }
    ...
    const program = typescript_1.default.createProgram([extra.filePath], commandLine.options, compilerHost);

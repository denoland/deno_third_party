...
var TypeParameterDeclarationStructurePrinter = /** @class */ (function (_super) {
    ...
    TypeParameterDeclarationStructurePrinter.prototype.printText = function (writer, structure) {
        ...
        if (structure.constraint != null) {
            var constraintText = this.getTextWithQueuedChildIndentation(writer, structure.constraint);
            if (!utils_1.StringUtils.isNullOrWhitespace(constraintText))
                writer.write(" extends " + constraintText);
        }
        if (structure.default != null) {
            var defaultText = this.getTextWithQueuedChildIndentation(writer, structure.default);
            if (!utils_1.StringUtils.isNullOrWhitespace(defaultText))

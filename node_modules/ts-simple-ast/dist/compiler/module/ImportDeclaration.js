...
var ImportDeclaration = /** @class */ (function (_super) {
    ...
    ImportDeclaration.prototype.removeDefaultImport = function () {
        ...
        if (importClause == null)
            return this;
        var defaultImport = importClause.getNodeProperty("name");
        if (defaultImport == null)
            return this;
    ...
    ImportDeclaration.prototype.insertNamedImports = function (index, structuresOrNames) {
        ...
        if (namedImports.length === 0) {
            ...
            if (importClause == null)
                ...
                var namedBindings = importClause.getNodeProperty("namedBindings");
                manipulation_1.insertIntoParentTextRange({
    ...
    ImportDeclaration.prototype.getNamedImports = function () {
        ...
        if (namedImports == null)
            return [];
        return namedImports.getChildSyntaxListOrThrow().getChildren().filter(utils_1.TypeGuards.isImportSpecifier);
    };
    /**
...
function setEmptyNamedImport(node) {
    ...
    var writer = node.getWriterWithQueuedChildIndentation();
    var namedImportStructurePrinter = node.context.structurePrinterFactory.forNamedImportExportSpecifier();
    ...
    var replaceNode = importClause.getNodeProperty("namedBindings");
    if (replaceNode != null) {
        manipulation_1.insertIntoParentTextRange({
            parent: importClause,

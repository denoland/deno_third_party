...
function BodyableNode(Base) {
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.getStructure = function () {
            var body = this.getBody();
            var bodyStructure = { bodyText: body == null ? undefined : helpers_1.getBodyTextForStructure(body) };
            return callBaseGetStructure_1.callBaseGetStructure(Base.prototype, this, bodyStructure);
        };
        return class_1;
    }(Base));
}

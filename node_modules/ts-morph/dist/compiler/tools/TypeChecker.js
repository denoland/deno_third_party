...
var TypeChecker = /** @class */ (function () {
     ...
     * @internal
     */
    TypeChecker.prototype._reset = function (getTypeChecker) {
        this._getCompilerObject = getTypeChecker;
    };
    /**
     * Gets the ambient module symbols (ex. modules in the @types folder or node_modules).
     */
    TypeChecker.prototype.getAmbientModules = function () {
        var _this = this;
        return this.compilerObject.getAmbientModules().map(function (s) { return _this._context.compilerFactory.getSymbol(s); });
    };
    /**
    ...
    TypeChecker.prototype.getPropertiesOfType = function (type) {
        var _this = this;
        return this.compilerObject.getPropertiesOfType(type.compilerType).map(function (p) { return _this._context.compilerFactory.getSymbol(p); });
    };
    /**
     * Gets the type text
    ...
    TypeChecker.prototype.getExportsOfModule = function (moduleSymbol) {
        ...
        return (symbols || []).map(function (s) { return _this._context.compilerFactory.getSymbol(s); });
    };
    /**
    ...
    TypeChecker.prototype._getDefaultTypeFormatFlags = function (enclosingNode) {

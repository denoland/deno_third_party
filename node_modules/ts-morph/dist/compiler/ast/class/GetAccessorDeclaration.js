...
exports.GetAccessorDeclarationBase = base_1.ChildOrderableNode(base_1.TextInsertableNode(base_1.DecoratableNode(base_2.AbstractableNode(base_1.ScopedNode(base_1.StaticableNode(function_1.FunctionLikeDeclaration(base_1.BodyableNode(base_1.PropertyNamedNode(common_1.Node)))))))));
var GetAccessorDeclaration = /** @class */ (function (_super) {
     ...
     */
    GetAccessorDeclaration.prototype.set = function (structure) {
     ...
     */
    GetAccessorDeclaration.prototype.getStructure = function () {

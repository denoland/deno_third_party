...
var ObjectLiteralExpression = /** @class */ (function (_super) {
    ...
    ObjectLiteralExpression.prototype.getProperties = function () {
        ...
        return properties.map(function (p) { return _this._getNodeFromCompilerNode(p); });
    };
    ...
    ObjectLiteralExpression.prototype.insertPropertyAssignments = function (index, structures) {
        var _this = this;
        return this._insertProperty(index, structures, function () { return _this._context.structurePrinterFactory.forPropertyAssignment(); });
    };
    ...
    ObjectLiteralExpression.prototype.insertShorthandPropertyAssignments = function (index, structures) {
        var _this = this;
        return this._insertProperty(index, structures, function () { return _this._context.structurePrinterFactory.forShorthandPropertyAssignment(); });
    };
    /* Spread Assignments */
    /**
    ...
    ObjectLiteralExpression.prototype.insertSpreadAssignments = function (index, structures) {
        var _this = this;
        return this._insertProperty(index, structures, function () { return _this._context.structurePrinterFactory.forSpreadAssignment(); });
    };
    /* Method Declarations */
    /**
     * Adds a method.
    ...
    ObjectLiteralExpression.prototype.insertMethods = function (index, structures) {
        var _this = this;
        return this._insertProperty(index, structures, function () { return _this._context.structurePrinterFactory.forMethodDeclaration({ isAmbient: false }); });
    };
    ...
    ObjectLiteralExpression.prototype.insertGetAccessors = function (index, structures) {
        var _this = this;
        return this._insertProperty(index, structures, function () { return _this._context.structurePrinterFactory.forGetAccessorDeclaration({ isAmbient: false }); });
    };
    ...
    ObjectLiteralExpression.prototype.insertSetAccessors = function (index, structures) {
        var _this = this;
        return this._insertProperty(index, structures, function () { return _this._context.structurePrinterFactory.forSetAccessorDeclaration({ isAmbient: false }); });
    };
    /**
     * @internal
     */

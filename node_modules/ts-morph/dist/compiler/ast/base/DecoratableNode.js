    ...
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.getDecorators = function () {
            ...
            if (this.compilerNode.decorators == null)
                return [];
            return this.compilerNode.decorators.map(function (d) { return _this._getNodeFromCompilerNode(d); });
        };
        ...
        class_1.prototype.set = function (structure) {
            ...
            if (structure.decorators != null) {
                this.getDecorators().forEach(function (d) { return d.remove(); });
        ...
        class_1.prototype.getStructure = function () {
            return callBaseGetStructure_1.callBaseGetStructure(Base.prototype, this, {
                decorators: this.getDecorators().map(function (d) { return d.getStructure(); })
            });
        };
        return class_1;
    }(Base));
...
function getDecoratorLines(node, structures) {
    ...
    try {
        for (var structures_1 = tslib_1.__values(structures), structures_1_1 = structures_1.next(); !structures_1_1.done; structures_1_1 = structures_1.next()) {
            ...
            var writer = node._getWriter();
            var structurePrinter = node._context.structurePrinterFactory.forDecorator();

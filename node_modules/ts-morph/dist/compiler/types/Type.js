...
var Type = /** @class */ (function () {
    ...
    Type.prototype.getAliasTypeArguments = function () {
        ...
        return aliasTypeArgs.map(function (t) { return _this._context.compilerFactory.getType(t); });
    };
    /**
    ...
    Type.prototype.getBaseTypes = function () {
        ...
        return baseTypes.map(function (t) { return _this._context.compilerFactory.getType(t); });
    };
    /**
    ...
    Type.prototype.getCallSignatures = function () {
        var _this = this;
        return this.compilerType.getCallSignatures().map(function (s) { return _this._context.compilerFactory.getSignature(s); });
    };
    /**
    ...
    Type.prototype.getConstructSignatures = function () {
        var _this = this;
        return this.compilerType.getConstructSignatures().map(function (s) { return _this._context.compilerFactory.getSignature(s); });
    };
    /**
    ...
    Type.prototype.getProperties = function () {
        var _this = this;
        return this.compilerType.getProperties().map(function (s) { return _this._context.compilerFactory.getSymbol(s); });
    };
    ...
    Type.prototype.getApparentProperties = function () {
        var _this = this;
        return this.compilerType.getApparentProperties().map(function (s) { return _this._context.compilerFactory.getSymbol(s); });
    };
    ...
    Type.prototype.getTypeArguments = function () {
        ...
        return typeArguments.map(function (t) { return _this._context.compilerFactory.getType(t); });
    };
    /**
    ...
    Type.prototype.getUnionTypes = function () {
        ...
        if (!this.isUnion())
            return [];
        return this.compilerType.types.map(function (t) { return _this._context.compilerFactory.getType(t); });
    };
    /**
    ...
    Type.prototype.isEnum = function () {
        var hasEnumFlag = this._hasTypeFlag(typescript_1.TypeFlags.Enum);
        if (hasEnumFlag)
            return true;
        ...
        if (symbol == null)
            return false;
        var valueDeclaration = symbol.getValueDeclaration();

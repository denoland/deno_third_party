...
var TypeGuards = /** @class */ (function () {
     ...
     * @param node - Node to check.
     */
    TypeGuards.isClassExpression = function (node) {
     ...
     * @param node - Node to check.
     */
    TypeGuards.isClassLikeDeclarationBase = function (node) {
        switch (node.getKind()) {
            case typescript_1.SyntaxKind.ClassDeclaration:
            case typescript_1.SyntaxKind.ClassExpression:
                return true;
     ...
     * @param node - Node to check.
     */
    TypeGuards.isExportGetableNode = function (node) {
        switch (node.getKind()) {
            case typescript_1.SyntaxKind.ClassDeclaration:
            case typescript_1.SyntaxKind.EnumDeclaration:
            case typescript_1.SyntaxKind.FunctionDeclaration:
     ...
     * @param node - Node to check.
     */
    TypeGuards.isImportClause = function (node) {
     ...
     * @param node - Node to check.
     */
    TypeGuards.isIndexedAccessTypeNode = function (node) {
     ...
     * @param node - Node to check.
     */
    TypeGuards.isJSDocFunctionType = function (node) {
     ...
     * @param node - Node to check.
     */
    TypeGuards.isJSDocSignature = function (node) {
     ...
     * @param node - Node to check.
     */
    TypeGuards.isJSDocType = function (node) {
        switch (node.getKind()) {
     ...
     * @param node - Node to check.
     */
    TypeGuards.isJSDocTypeExpression = function (node) {
     ...
     * @param node - Node to check.
     */
    TypeGuards.isModuleBlock = function (node) {
     ...
     * @param node - Node to check.
     */
    TypeGuards.isModuledNode = function (node) {
        switch (node.getKind()) {
            case typescript_1.SyntaxKind.ModuleDeclaration:
     ...
     * @param node - Node to check.
     */
    TypeGuards.isNamedExports = function (node) {
     ...
     * @param node - Node to check.
     */
    TypeGuards.isNamedImports = function (node) {
     ...
     * @param node - Node to check.
     */
    TypeGuards.isNamespaceImport = function (node) {

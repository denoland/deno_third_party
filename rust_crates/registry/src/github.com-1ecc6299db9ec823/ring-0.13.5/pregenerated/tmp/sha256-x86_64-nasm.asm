...
GFp_sha256_block_data_order_shaext:
	...
	mov	QWORD[16+rsp],rsi
	mov	rax,rsp
$L$SEH_begin_GFp_sha256_block_data_order_shaext:
	mov	rdi,rcx
	mov	rsi,rdx
	mov	rdx,r8
...
$L$epilogue_shaext:
	...
	mov	rsi,QWORD[16+rsp]
	DB	0F3h,0C3h		;repret
$L$SEH_end_GFp_sha256_block_data_order_shaext:
...
ALIGN	64
GFp_sha256_block_data_order_avx2:
	mov	QWORD[8+rsp],rdi	;WIN64 prologue
	mov	QWORD[16+rsp],rsi
	mov	rax,rsp
$L$SEH_begin_GFp_sha256_block_data_order_avx2:
	mov	rdi,rcx
	mov	rsi,rdx
	mov	rdx,r8
...
$L$epilogue_avx2:
	...
	mov	rsi,QWORD[16+rsp]
	DB	0F3h,0C3h		;repret
$L$SEH_end_GFp_sha256_block_data_order_avx2:
...
ALIGN	4
	...
	DD	$L$SEH_begin_GFp_sha256_block_data_order_shaext wrt ..imagebase
	DD	$L$SEH_end_GFp_sha256_block_data_order_shaext wrt ..imagebase
	DD	$L$SEH_info_GFp_sha256_block_data_order_shaext wrt ..imagebase
	...
	DD	$L$SEH_begin_GFp_sha256_block_data_order_avx2 wrt ..imagebase
	DD	$L$SEH_end_GFp_sha256_block_data_order_avx2 wrt ..imagebase
	DD	$L$SEH_info_GFp_sha256_block_data_order_avx2 wrt ..imagebase
...
$L$SEH_info_GFp_sha256_block_data_order_shaext:
DB	9,0,0,0
...
$L$SEH_info_GFp_sha256_block_data_order_avx2:
DB	9,0,0,0
	DD	se_handler wrt ..imagebase

...
global	_GFp_aesni_encrypt
align	16
_GFp_aesni_encrypt:
L$_GFp_aesni_encrypt_begin:
	mov	eax,DWORD [4+esp]
...
db	102,15,56,221,248
	ret
global	_GFp_aesni_ctr32_encrypt_blocks
align	16
_GFp_aesni_ctr32_encrypt_blocks:
L$_GFp_aesni_ctr32_encrypt_blocks_begin:
	push	ebp
	push	ebx
	push	esi
	push	edi
...
L$016pic:
	...
	cmp	ecx,192
	je	NEAR L$01812rounds
	cmp	ecx,128
	jne	NEAR L$019bad_keybits
align	16
L$02010rounds:
	cmp	ebp,268435456
	je	NEAR L$02110rounds_alt
	mov	ecx,9
	movups	[edx-16],xmm0
db	102,15,58,223,200,1
	call	L$022key_128_cold
...
L$01812rounds:
	movq	xmm2,[16+eax]
	cmp	ebp,268435456
	je	NEAR L$02612rounds_alt
	mov	ecx,11
	movups	[edx-16],xmm0
db	102,15,58,223,202,1
	call	L$027key_192a_cold
...
L$01714rounds:
	...
	lea	edx,[16+edx]
	cmp	ebp,268435456
	je	NEAR L$03214rounds_alt
	mov	ecx,13
	movups	[edx-32],xmm0
	movups	[edx-16],xmm2
db	102,15,58,223,202,1
	call	L$033key_256a_cold
db	102,15,58,223,200,1
	call	L$034key_256b
db	102,15,58,223,202,2
	call	L$035key_256a
...
L$019bad_keybits:
	...
	pop	ebp
	ret
global	_GFp_aesni_set_encrypt_key
align	16
_GFp_aesni_set_encrypt_key:
L$_GFp_aesni_set_encrypt_key_begin:
	mov	eax,DWORD [4+esp]
	mov	ecx,DWORD [8+esp]
	mov	edx,DWORD [12+esp]
